        ...
        <main className="login-container">
                <div className="login-form-container bg-black ">
                    ...
                    <form action="post" className="login-form" onSubmit={submitHandler}>
                        <label className="text-white" htmlFor="email"><span>Email address</span> 
                             <input required id="email" name="email" onChange={changeHandler} type="email" placeholder="abc@neog.com"/>
                        </label>
                        <label className="text-white" htmlFor="firstName"><span>First Name</span> 
                            <input  id="firstName" name="firstName" required onChange={changeHandler} type="text" placeholder="First Name"/>
                        </label>
                        <label className="text-white" htmlFor="lastName"><span>Last Name</span> 
                             <input id="lastName" name="lastName" required onChange={changeHandler} type="text" placeholder="Last Name"/>
                        </label>
                        
                        <label className="text-white" htmlFor="password"><span>Password</span>
                        ...
                        <label className="text-white"  htmlFor="confirmPassword"><span>Confirm Password</span>
                        ...
                        {passLen? null :<span className="mismatch">Password must have minimum of 8 characters</span>}
                        
                        <div>
                            <label htmlFor="accept-condition" className="text-white"><input id="accept-condition" required type="checkbox"/> I accept all Terms & Conditions</label>
