...
const NotesModal = ({videoId,player,setShowNotesForm}) => {
  ...
  return (
    <div className={classes["notes-modal"]}>
      <form action="post" className={classes["notes-form"]} onSubmit={submitHandler}>
      <i
        ...
        <label htmlFor="title">
          Title <br />
          <input name="title" type="text" onChange={changeHandler} placeholder="Title" />
        </label>
        <label htmlFor="description">
            <textarea name="description" onChange={changeHandler} placeholder="Description" className={classes["textarea"]}></textarea>
        </label>
